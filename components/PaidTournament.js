...
const PaidTournament = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Text style = {styles.orange}>Aguardando Confirmação de um ADM</Text>
      </View>
      <TouchableOpacity style={styles.moreInfoButton} onPress={() => navigation.navigate('UserTournamentPaid')}>
            <Text style={styles.moreInfoButtonText}>Voltar a seus torneios</Text>
          </TouchableOpacity>
    </View>
