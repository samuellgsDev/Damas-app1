...
const UserTournamentPaid = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tournamentsSection}>
        <View style={styles.tournamentCard}>
          ...
          <Text style = {styles.cardText}>Status da Inscrição:{"\n"}<Text style={{color : "orange"}}>Aguardando analise de um ADM</Text></Text>
          </View>
          <TouchableOpacity style={styles.moreInfoButton} onPress={() => navigation.navigate('PaidTournament')}>
...
export default UserTournamentPaid;
